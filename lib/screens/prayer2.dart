...
class _PrayerScreenState extends State<PrayerScreen> {
  ...
  // Fixed prayer times (these will always be present)
  ...
  // User-created notifications (from SharedPreferences)
  ...
  void _deletePrayerNotification(int index) async {
    ...
    await notifservice.NotificationService().cancelNotification(
      prayerNotifications[index].name.hashCode,
    );
    _saveNotifications();
  }
                    ...
                    ? Dismissible(
                        ...
                        onDismissed: (direction) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text('Prayer Notification deleted')),
                          );
                        },
                            ...
                            NotificationDialog.show(
                              ...
                              onSave: (updatedNotification) {
                                ...
                                notifservice.NotificationService()
                                  ...
                                  index -
                                      prayerTimes
                                          .length, // Corrected usage of notification
                                );
                              },
                            );
                          },
